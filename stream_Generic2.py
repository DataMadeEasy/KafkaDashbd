...
def stream_twitter_topic(param_subject):
    ...
    ckey = credentials.TwitterCredentials2['APIKey']
    csecret = credentials.TwitterCredentials2['APISecretKey']
    atoken = credentials.TwitterCredentials2['AccessToken']
    asecret = credentials.TwitterCredentials2['AccessTokenSecret']
